...
<head>
	...
	<script>
		...
		/* function confirmIdPopup(inputForm){	
			...
			var url = "/spring/aopMember/idAvail.do?id="+inputForm.id.value;
	...
	<script>
		$(document).ready(function(){
			$("#id").change(function(){
				...
				$.ajax({
					type : "post",
					url : "/spring/aopMember/ajaxIdAvail.do",	// 처리할 곳으로 보내주고
					data : {id : id},
...
<body>
	...
	<form action="/spring/aopMember/signupPro.do" method="post" name="inputForm" >
	<table>
		<tr>
			<td>아이디 * </td>
