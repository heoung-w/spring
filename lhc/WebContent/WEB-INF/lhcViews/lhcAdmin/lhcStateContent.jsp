...
<h3 align="center">PC방 정보</h3>
	<table>
		...
		<tr>
			<td colspan="3">
				<c:if test="${state == 'b'}">
					<button onclick="window.location.href='/lhc/lhcPc/lhcPcAdRegisterPro.lhc?num=${pc.lhc_num}&state=${state}'">등록</button>
				</c:if>
				<button onclick="window.location.href='/lhc/lhcPc/lhcPcDelete.lhc?num=${pc.lhc_num}'">삭제</button>
...
<h3 align="center">PC방 정보</h3>
	<table>
		...
		<tr>
			<td colspan="3">
				<button onclick="window.location.href='/lhc/lhc/.lhc'">수정</button>
				<button onclick="window.location.href='/lhc/lhcPc/lhcPcDelete.lhc?num=${pc.lhc_num}'">삭제</button>
				<button onclick="window.location.href='history.go(-2)'">닫기</button>			
			</td>
		</tr>
	</table>
